...
interface JQuery {
     ...
     *
     * @param className One or more space-separated typescript to be added to the class attribute of each matched element.
     */
    ...
    /**
     * Remove a single class, multiple typescript, or all typescript from each element in the set of matched elements.
     *
     * @param className One or more space-separated typescript to be removed from the class attribute of each matched element.
     */
    ...
    /**
     * Add or remove one or more typescript from each element in the set of matched elements, depending on either the class's presence or the value of the switch argument.
     *
