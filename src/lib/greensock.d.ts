...
declare class TweenMax extends TweenLite {
	...
	static allTo( targets:Object[] , duration:number , vars:Object ):TweenMax;
	static all( targets:Object[] , duration:number , vars:Object ):TweenMax;
...
declare class Draggable {
	static create(target:Object, vars?:Object):Draggable[];
	...
	// NOTE: This is not a documented part of the API
	vars:any;

	constructor(target:Object, vars?:Object);

	applyBounds(newBounds?:Object):Draggable;
	create(target:Object, vars:Object):Draggable[];
	disable():Draggable;
	enable():Draggable;
	endDrag(event:Object):Draggable;
	get(target:Object):Draggable;
	hitTest(testObject:Object, threshold?:any):boolean;
	hitTest(testObject1:Object, testObject2:Object, threshold?:any):boolean;
	kill():Draggable;
	startDrag(event:Object):Draggable;
...
//declare var ThrowPropsPlugin:TweenPlugin;
declare var TweenPlugin:TweenPlugin;

declare class ThrowPropsPlugin
{
	static track:any;
	getVelocity(target:Element,property:string):number;
}

//com.greensock.utils
//declare var Draggable:Draggable;
//declare var SplitText:SplitText;
//declare var VelocityTracker:VelocityTracker;
